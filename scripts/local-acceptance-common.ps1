...
function Initialize-LocalAcceptanceEnvironment {
    ...
    $optionalSettings = @(
        ...
        "COOKIES_OCEAN_ENGINE_ENABLED",
        "COOKIES_OCEAN_ENGINE_BASE_URL",
        "COOKIES_OCEAN_ENGINE_BUSINESS_BASE_URL",
        "COOKIES_OCEAN_ENGINE_MASTER_KEY",
        "COOKIES_OCEAN_ENGINE_MASTER_KEY_VERSION",
        "COOKIES_OCEAN_ENGINE_PATROL_ENABLED",
        "COOKIES_OCEAN_ENGINE_PATROL_INTERVAL_HOURS",
        "COOKIES_OCEAN_ENGINE_PATROL_LOOKBACK_DAYS",
        "COOKIES_OCEAN_ENGINE_WEB_API_WRITE_ENABLED",
        "COOKIES_OCEAN_ENGINE_WEB_API_WRITE_ACCOUNT_ALLOWLIST",
        "COOKIES_OCEAN_ENGINE_WEB_API_TEMPLATE_FILE",
        "COOKIES_BROWSER_RPA_ENABLED",
        "COOKIES_BROWSER_RPA_RUNNER_PROTOCOL",
        "COOKIES_BROWSER_RPA_CDP_ENDPOINT",
        "COOKIES_BROWSER_RPA_TSX_COMMAND",
        "COOKIES_BROWSER_RPA_SCRIPT",
        "COOKIES_BROWSER_RPA_EVIDENCE_ROOT",
        "COOKIES_BROWSER_RPA_EDGE_SESSION_FILE",
        "COOKIES_BROWSER_RPA_SESSION_PROBE_SCRIPT",
        "COOKIES_BROWSER_RPA_AUTHORITY_STATE_ROOT",
        "COOKIES_BROWSER_RPA_PREPARE_TIMEOUT_SECONDS",
        "COOKIES_BROWSER_RPA_SUBMIT_TIMEOUT_SECONDS"
    )
