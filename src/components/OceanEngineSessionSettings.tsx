...
const objectKindCopy: Record<ApiConnectorPlatformObjectKind, string> = {
  image_material: '图片素材', product_image: '我的图片', video_material: '视频素材', douyin_video: '抖音原生视频', aweme_photo_material: '抖音图文',
  marketing_product: '营销产品', application: '应用', orange_landing_page: '橙子落地页',
